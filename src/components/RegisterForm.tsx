...
import { LegalConsentLabel } from "@/components/LegalLinks";
...
export function RegisterForm({ serverInfo, onSwitchToLogin, onComplete }: Props) {
    ...
    <form onSubmit={handleRegisterSubmit} className="space-y-4">
      ...
      <div className="space-y-1">
        ...
        <input
          ...
          className={touched.displayName && displayNameTooShort ? inputErrorClass : inputClass}
      ...
      <div className="space-y-1">
        ...
        {touched.password && tooShort && (
          <p className="mt-1 text-xs text-red-600 dark:text-red-400">{t("password_too_short")}</p>
        )}
      </div>
      <div className="space-y-1">
        ...
        {touched.confirmPassword && mismatch && (
          <p className="mt-1 text-xs text-red-600 dark:text-red-400">{t("passwords_dont_match")}</p>
        )}
      </div>
      {ageGate && (
        <div className="space-y-1">
